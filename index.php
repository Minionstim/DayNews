	  ...
	  <div class="leftDiv">
	    ...
	    <div class="loginDiv">
	      ...
	      <div class="loginDiv2 clear">
	        ...
	        <div class="loginDiv21"><input type="text" name="checkCode" size="8" maxlength="4"><img id="myImg" onclick="changeImg()"  alt="看不清换一张" title="看不清换一张" src="image.php" align="absmiddle"></div>
	      </div>
	      <div class="loginDiv2 clear">
